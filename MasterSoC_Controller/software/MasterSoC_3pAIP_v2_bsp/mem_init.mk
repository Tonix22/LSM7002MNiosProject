...
# Memory: mem_program
MEM_0 := master_nios_multiple_slave_mem_program
$(MEM_0)_NAME := mem_program
...
$(MEM_0)_END := 0x0003e7ff
$(MEM_0)_SPAN := 0x0003e800
$(MEM_0)_HIERARCHICAL_PATH := mem_program
$(MEM_0)_WIDTH := 32
...
.PHONY: mem_program
mem_program: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
