...
typedef int spi_config_num_callback_dup_1(LMS7002M_t *,  const int );
typedef int one_param_lms7002m_chan_num_callback_dup_2(LMS7002M_t *, const LMS7002M_chan_t);
typedef uint16_t readrssi_num_callback(LMS7002M_t *, const LMS7002M_chan_t);
typedef void one_param_lms7002m_chan_num_callback_dup_1(LMS7002M_t *,  const LMS7002M_dir_t );
